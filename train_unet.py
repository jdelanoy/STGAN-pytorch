...
from pl_systems.unet import NormalUnet
...
def main(hparams):
    ...
    model = NormalUnet(hparams=hparams)
...
if __name__ == '__main__':
    ...
    experiment_version = 'first_trial'
    ...
    hparams = NormalUnet.add_ckpt_args(hparams).parse_args()
